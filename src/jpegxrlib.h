 ...
 * jpeg_common_struct, only of jpeg_compress_struct and jpegxr_decompress_struct.
 */
struct jpeg_common_struct {
  jpeg_common_fields;		/* Fields common to both master struct types */
  /* Additional fields follow in an actual jpeg_compress_struct or
   * jpegxr_decompress_struct.  All three structs must agree on these
...
struct jpeg_compress_struct {
  jpeg_common_fields;		/* Fields shared with jpegxr_decompress_struct */
...
#define jpegxr_CreateDecompress	jxrCreaDecompress
#define jpeg_destroy_compress	jDestCompress
#define jpegxr_destroy_decompress	jxrDestDecompress
...
#define jpegxr_CreateDecompress	jpegxr_CreateDecompress_12
#define jpeg_destroy_compress	jpeg_destroy_compress_12
#define jpegxr_destroy_decompress	jpegxr_destroy_decompress_12
...
#define jpeg_create_compress(cinfo) \
    jpeg_CreateCompress((cinfo), JPEGXR_LIB_VERSION, \
